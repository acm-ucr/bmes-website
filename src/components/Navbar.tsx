...
const Navbar = () => {
    return (
        <>
        <div className="flex items-center justify-between px-6 py-4 bg-bmes-blue-100 text-white">
            <div className="pl-12">
            ...
            <div className="flex items-center gap-8 pr-10 text-lg">
                ...
                <Link href={header_items[6].link} className="bg-bmes-blue-300 px-4 py-2 rounded-2xl">
                    {header_items[6].name}
                </Link>
            </div>
        </div>
