...
const AboutCard = ({ info, onClose }: AboutInfo) => {
  return (
    <div className="from-bmes-blue-400 to-bmes-blue-500 absolute left-1/2 z-50 w-[90vw] max-w-2xl -translate-x-1/2 rounded-md bg-gradient-to-b px-8 py-10 text-left font-extralight shadow-xl">
      <button
        onClick={onClose}
